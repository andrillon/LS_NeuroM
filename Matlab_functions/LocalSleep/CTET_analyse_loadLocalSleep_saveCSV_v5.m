...
for nF=1:length(filesPLA)
    ...
    if exist([save_path filesep 'SW_detection' filesep 'CIcfe_blocks_ft_allSW_' File_Name(1:end-4) '.mat'])==0
        continue;
    end
    load([save_path filesep 'SW_detection' filesep 'CIcfe_blocks_ft_allSW_' File_Name(1:end-4)]); %,'all_Waves','hdr')

...
for nF=1:length(files)
 ...
 if hdr.Fs~=1024 || length(unique(table.BlockN(table.SubID==SubN & table.SessN==SessN)))~=10
    ...
    if exist(['/Users/tand0009/Data/CTET_Dockree/CTET_' File_Name(1:end-4) '_FOOOF_FFT_perBlock_byElec_avMast.mat'])==0
        ...
        save(['/Users/tand0009/Data/CTET_Dockree/CTET_' File_Name(1:end-4) '_FOOOF_FFT_perBlock_byElec_avMast.mat'],'all_pow','myfreqs');
    else

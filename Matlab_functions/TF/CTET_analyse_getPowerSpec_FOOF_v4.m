...
for nF=1:length(files)
    ...
    nFc=nFc+1;
    if redo==1 || exist(['/Users/tand0009/Data/CTET_Dockree/CTET_' File_Name(1:end-4) '_FOOOF_FFT_perBlock_byElec_avMast_denoise.mat'])==0
        all_peaks=[];
        all_bg=[];
        all_pow=[];
        all_spec=[];
        ...
        if denoiseflag
            ...
            [c0,c1]=nt_bias_fft(temp_data',[50 100 150]/hdr.Fs, hdr.Fs);
            ...
            % DSS components
            z=nt_mmat(temp_data',todss);
            
            % first components are most dominated by 50Hz & harmonics
            NREMOVE=20;
            clean_data=nt_tsr(temp_data',z(:,1:NREMOVE,:)); % regress them out
        ...
        for nBl=1:10
            ...
            for nEl=1:64
                ...
                block_data=temp_data(nEl,(first_trial:last_trial));
                
                w_window=10*hdr.Fs;
                w_overlap=w_window/2;
                df=0.2;
                freqV=1:0.1:50;
                [pow,faxis] = pwelch(block_data,w_window,w_overlap,freqV,hdr.Fs,'psd');
        ...
        save(['/Users/tand0009/Data/CTET_Dockree/CTET_' File_Name(1:end-4) '_FOOOF_FFT_perBlock_byElec_avMast_denoise.mat'],'all_pow','myfreqs','all_peaks','all_bg','DrugC',...

...
names(SWS_data)[names(SWS_data) == "Drug"] <- "Treatmentment"

SWS_data$Treatmentment<-as.factor(SWS_data$Treatmentment)

SWS_data$Treatmentment<-relevel(SWS_data$Treatmentment,"PLA")

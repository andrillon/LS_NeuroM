...
### TRY ALL DRUGS
SWS_data_Target<-SWS_data[SWS_data$StimType==1,] #|: . $: and
SWS_data_Target$SubID<-as.factor(SWS_data_Target$SubID)

med.fit1 <- glmer(Fz  ~ 1 + Treatment + (1|SubID), data = SWS_data_Target, family="binomial")
out.fit1 <- glmer(Miss  ~ 1 + Fz+Treatment + (1|SubID), data = SWS_data_Target, family="binomial")
...
write.table(MPH_RT_Est,file="../Tables/CTET_Mediation_allE_MPH_RT_Est_perTrial_v3.txt")
write.table(MPH_RT_pV,file="../Tables/CTET_Mediation_allE_MPH_RT_pV_perTrial_v3.txt")
write.table(MPH_Miss_Est,file="../Tables/CTET_Mediation_allE_MPH_Miss_Est_perTrial_v3.txt")
write.table(MPH_Miss_pV,file="../Tables/CTET_Mediation_allE_MPH_Miss_pV_perTrial_v3.txt")
...
write.table(ATM_RT_Est,file="../Tables/CTET_Mediation_allE_ATM_RT_Est_perTrial_v3.txt")
write.table(ATM_RT_pV,file="../Tables/CTET_Mediation_allE_ATM_RT_pV_perTrial_v3.txt")
write.table(ATM_Miss_Est,file="../Tables/CTET_Mediation_allE_ATM_Miss_Est_perTrial_v3.txt")
write.table(ATM_Miss_pV,file="../Tables/CTET_Mediation_allE_ATM_Miss_pV_perTrial_v3.txt")
...
write.table(CIT_RT_Est,file="../Tables/CTET_Mediation_allE_CIT_RT_Est_perTrial_v3.txt")
write.table(CIT_RT_pV,file="../Tables/CTET_Mediation_allE_CIT_RT_pV_perTrial_v3.txt")
write.table(CIT_Miss_Est,file="../Tables/CTET_Mediation_allE_CIT_Miss_Est_perTrial_v3.txt")
write.table(CIT_Miss_pV,file="../Tables/CTET_Mediation_allE_CIT_Miss_pV_perTrial_v3.txt")

---
title: "CTET_Mediation_byE_v6.rmd"
author: "Elaine P."
date: "28/04/2021"
...
SWS_data <- read.table("../Tables/CTET_SWdetection_thr90_byE_P2P_behav_vec_v6.txt", header = TRUE, sep = ",", stringsAsFactors = FALSE)
...
write.table(MPH_RT_Est,file="../Tables/CTET_Mediation_allE_MPH_RT_Est_v6.txt")
write.table(MPH_RT_pV,file="../Tables/CTET_Mediation_allE_MPH_RT_pV_v6.txt")
write.table(MPH_Miss_Est,file="../Tables/CTET_Mediation_allE_MPH_Miss_Est_v6.txt")
write.table(MPH_Miss_pV,file="../Tables/CTET_Mediation_allE_MPH_Miss_pV_v6.txt")
write.table(MPH_FA_Est,file="../Tables/CTET_Mediation_allE_MPH_FA_Est_v6.txt")
write.table(MPH_FA_pV,file="../Tables/CTET_Mediation_allE_MPH_FA_pV_v6.txt")
```
NEG MPH ON RT: 
...
write.table(ATM_RT_Est,file="../Tables/CTET_Mediation_allE_ATM_RT_Est_v6.txt")
write.table(ATM_RT_pV,file="../Tables/CTET_Mediation_allE_ATM_RT_pV_v6.txt")
write.table(ATM_Miss_Est,file="../Tables/CTET_Mediation_allE_ATM_Miss_Est_v6.txt")
write.table(ATM_Miss_pV,file="../Tables/CTET_Mediation_allE_ATM_Miss_pV_v6.txt")
write.table(ATM_FA_Est,file="../Tables/CTET_Mediation_allE_ATM_FA_Est_v6.txt")
write.table(ATM_FA_pV,file="../Tables/CTET_Mediation_allE_ATM_FA_pV_v6.txt")
```
...
write.table(CIT_RT_Est,file="../Tables/CTET_Mediation_allE_CIT_RT_Est_v6.txt")
write.table(CIT_RT_pV,file="../Tables/CTET_Mediation_allE_CIT_RT_pV_v6.txt")
write.table(CIT_Miss_Est,file="../Tables/CTET_Mediation_allE_CIT_Miss_Est_v6.txt")
write.table(CIT_Miss_pV,file="../Tables/CTET_Mediation_allE_CIT_Miss_pV_v6.txt")
write.table(CIT_FA_Est,file="../Tables/CTET_Mediation_allE_CIT_FA_Est_v6.txt")
write.table(CIT_FA_pV,file="../Tables/CTET_Mediation_allE_CIT_FA_pV_v6.txt")
```

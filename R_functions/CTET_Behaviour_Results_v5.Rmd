...
ggplot(summary_RT, aes(x = Treatment, y = Hit_RT, fill = Treatment)) +
  ...
  font("ylab", size = 14) + font("xlab", size = 14) + font("y.text", size = 12.5) + font("x.text", size = 12.5) + scale_y_continuous(labels = scales::number_format(accuracy = .01)) + theme(legend.position="none") + coord_cartesian(ylim =c(1, 1.7))
...
ggplot(summary_miss, aes(x = Treatment, y = Miss, fill = Treatment)) +
  ...
  font("ylab", size = 14) + font("xlab", size = 14) + font("y.text", size = 12.5) + font("x.text", size = 12.5) +
  scale_y_continuous(labels = scales::percent_format(accuracy = 1)) + theme(legend.position="none")
...
ggplot(summary_crit, aes(x = Treatment, y = crit, fill = Treatment)) +
  ...
  font("ylab", size = 14) + font("xlab", size = 14) + font("y.text", size = 12.5) + font("x.text", size = 12.5) + scale_y_continuous(labels = scales::number_format(accuracy = .01)) + theme(legend.position="none")

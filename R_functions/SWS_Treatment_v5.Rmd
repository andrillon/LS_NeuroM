...
ggsave(file="../Figures/CTET_BarPlot_Dens_ByE_2021.png", dpi = 600, 
       width = 15/2,
      height = 18/2,
    units = c("cm"))
```
...
ggsave(file="../Figures/CTET_BarPlot_P2P_byE_2021.png", dpi = 600, 
       width = 15/2,
      height = 18/2,
    units = c("cm"))
```
...
ggsave(file="../Figures/CTET_BarPlot_PosSlope_byE_2021.png", dpi = 600, 
       width = 15/2,
      height = 18/2,
    units = c("cm"))
```
...
ggsave(file="../Figures/CTET_BarPlot_NegSlope_ByE_2021.png", dpi = 600, 
       width = 15/2,
      height = 18/2,
    units = c("cm"))
```
...
ggplot(summary_SWdens, aes(x = Treatment, y = SWdens, fill = Treatment)) +
  ...
  scale_fill_manual(values = c("#666666", "#d95f02", "#7570b3", "#1b9e77")) + scale_colour_manual(values = c("#666666", "#d95f02", "#7570b3", "#1b9e77")) +xlab("Treatment") + ylab("Mean Slow Wave Density") + theme(panel.background = element_blank(), axis.line = element_line(colour = "black")) +

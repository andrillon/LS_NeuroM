...
for(i in channels.names){ 
  ...
  med.fit0 <- glmer(SWdens  ~ 1 + Treatment + (1|SubID), data = tmp)
    ...
    # run mediation on RT
  out.fit1 <- glmer(Hit_RT  ~ 1 + SWdens * Treatment + (1|SubID), data = tmp)
...
write.table(MPH_RT_Est,file="../Tables/CTET_Mediation_byE_MPH_RT_Est_v2.txt")
write.table(MPH_RT_pV,file="../Tables/CTET_Mediation_byE_MPH_RT_pV_v2.txt")
write.table(MPH_Miss_Est,file="../Tables/CTET_Mediation_byE_MPH_Miss_Est_v2.txt")
write.table(MPH_Miss_pV,file="../Tables/CTET_Mediation_byE_MPH_Miss_pV_v2.txt")
write.table(MPH_FA_Est,file="../Tables/CTET_Mediation_byE_MPH_FA_Est_v2.txt")
write.table(MPH_FA_pV,file="../Tables/CTET_Mediation_byE_MPH_FA_pV_v2.txt")
```
NEG MPH ON RT: 
...
write.table(ATM_RT_Est,file="../Tables/CTET_Mediation_byE_ATM_RT_Est_v2.txt")
write.table(ATM_RT_pV,file="../Tables/CTET_Mediation_byE_ATM_RT_pV_v2.txt")
write.table(ATM_Miss_Est,file="../Tables/CTET_Mediation_byE_ATM_Miss_Est_v2.txt")
write.table(ATM_Miss_pV,file="../Tables/CTET_Mediation_byE_ATM_Miss_pV_v2.txt")
write.table(ATM_FA_Est,file="../Tables/CTET_Mediation_byE_ATM_FA_Est_v2.txt")
write.table(ATM_FA_pV,file="../Tables/CTET_Mediation_byE_ATM_FA_pV_v2.txt")
```
...
write.table(CIT_RT_Est,file="../Tables/CTET_Mediation_byE_CIT_RT_Est_v2.txt")
write.table(CIT_RT_pV,file="../Tables/CTET_Mediation_byE_CIT_RT_pV_v2.txt")
write.table(CIT_Miss_Est,file="../Tables/CTET_Mediation_byE_CIT_Miss_Est_v2.txt")
write.table(CIT_Miss_pV,file="../Tables/CTET_Mediation_byE_CIT_Miss_pV_v2.txt")
write.table(CIT_FA_Est,file="../Tables/CTET_Mediation_byE_CIT_FA_Est_v2.txt")
write.table(CIT_FA_pV,file="../Tables/CTET_Mediation_byE_CIT_FA_pV_v2.txt")
```

...
write.table(MPH_RT_Est,file="../Tables/CTET_Mediation_allE_MPH_RT_Est_perTrial.txt")
write.table(MPH_RT_pV,file="../Tables/CTET_Mediation_allE_MPH_RT_pV_perTrial.txt")
write.table(MPH_Miss_Est,file="../Tables/CTET_Mediation_allE_MPH_Miss_Est_perTrial.txt")
write.table(MPH_Miss_pV,file="../Tables/CTET_Mediation_allE_MPH_Miss_pV_perTrial.txt")
...
write.table(ATM_RT_Est,file="../Tables/CTET_Mediation_allE_ATM_RT_Est_perTrial.txt")
write.table(ATM_RT_pV,file="../Tables/CTET_Mediation_allE_ATM_RT_pV_perTrial.txt")
write.table(ATM_Miss_Est,file="../Tables/CTET_Mediation_allE_ATM_Miss_Est_perTrial.txt")
write.table(ATM_Miss_pV,file="../Tables/CTET_Mediation_allE_ATM_Miss_pV_perTrial.txt")
...
write.table(CIT_RT_Est,file="../Tables/CTET_Mediation_allE_CIT_RT_Est_perTrial.txt")
write.table(CIT_RT_pV,file="../Tables/CTET_Mediation_allE_CIT_RT_pV_perTrial.txt")
write.table(CIT_Miss_Est,file="../Tables/CTET_Mediation_allE_CIT_Miss_Est_perTrial.txt")
write.table(CIT_Miss_pV,file="../Tables/CTET_Mediation_allE_CIT_Miss_pV_perTrial.txt")

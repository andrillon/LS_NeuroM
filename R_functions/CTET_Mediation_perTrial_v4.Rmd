...
SWS_data_MPH<-SWS_data_MPH[SWS_data_MPH$StimType==1 & is.na(SWS_data_MPH$Miss)==FALSE,] #|: . $: and
...
med.fit1 <- glmer(Fz  ~ 1 + Treatment + (1|SubID), data = SWS_data_MPH, family="binomial")
out.fit1 <- glmer(Miss  ~ 1 + Fz+Treatment + (1|SubID), data = SWS_data_MPH, family="binomial")

med.out1 <- mediate(med.fit1, out.fit1, treat = "Treatment", mediator = "Fz",boot = FALSE, sims = nsims)
#summary(med.out1)
...
for(i in channels.names){ 
  ...
  med.fit0 <- glmer(fml0, data = tmp1, family="binomial")
  ...
  out.fit2 <- glmer(fml1, data = tmp1, family="binomial")
...
write.table(MPH_RT_Est,file="../Tables/CTET_Mediation_allE_MPH_RT_Est_perTrial_v4.txt")
write.table(MPH_RT_pV,file="../Tables/CTET_Mediation_allE_MPH_RT_pV_perTrial_v4.txt")
write.table(MPH_Miss_Est,file="../Tables/CTET_Mediation_allE_MPH_Miss_Est_perTrial_v4.txt")
write.table(MPH_Miss_pV,file="../Tables/CTET_Mediation_allE_MPH_Miss_pV_perTrial_v4.txt")
...
SWS_data_ATM<-SWS_data_ATM[SWS_data_ATM$StimType==1 & is.na(SWS_data_ATM$Miss)==FALSE,] #|: . $: and
...
med.fit1 <- glmer(Fz  ~ 1 + Treatment + (1|SubID), data = SWS_data_ATM, family="binomial")
out.fit1 <- glmer(Miss  ~ 1 + Fz+Treatment + (1|SubID), data = SWS_data_ATM, family="binomial")
...
write.table(ATM_RT_Est,file="../Tables/CTET_Mediation_allE_ATM_RT_Est_perTrial_v4.txt")
write.table(ATM_RT_pV,file="../Tables/CTET_Mediation_allE_ATM_RT_pV_perTrial_v4.txt")
write.table(ATM_Miss_Est,file="../Tables/CTET_Mediation_allE_ATM_Miss_Est_perTrial_v4.txt")
write.table(ATM_Miss_pV,file="../Tables/CTET_Mediation_allE_ATM_Miss_pV_perTrial_v4.txt")
...
SWS_data_CIT<-SWS_data_CIT[SWS_data_CIT$StimType==1 & is.na(SWS_data_CIT$Miss)==FALSE,] #|: . $: and
...
med.fit1 <- glmer(Fz  ~ 1 + Treatment + (1|SubID), data = SWS_data_CIT, family="binomial")
out.fit1 <- glmer(Miss  ~ 1 + Fz+Treatment + (1|SubID), data = SWS_data_CIT, family="binomial")
...
write.table(CIT_RT_Est,file="../Tables/CTET_Mediation_allE_CIT_RT_Est_perTrial_v4.txt")
write.table(CIT_RT_pV,file="../Tables/CTET_Mediation_allE_CIT_RT_pV_perTrial_v4.txt")
write.table(CIT_Miss_Est,file="../Tables/CTET_Mediation_allE_CIT_Miss_Est_perTrial_v4.txt")
write.table(CIT_Miss_pV,file="../Tables/CTET_Mediation_allE_CIT_Miss_pV_perTrial_v4.txt")

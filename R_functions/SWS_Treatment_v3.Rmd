...
SWS_data3<-aggregate(SWdens ~ SubID+Treatment, data=SWS_data, FUN=mean)
...
##Barplot 
sw2.graph <- summarySE(SWS_data3, measurevar = "SWdens", groupvars = c( "Treatment"))
